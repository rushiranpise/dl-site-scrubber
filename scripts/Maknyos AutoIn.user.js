...
(function () {
  ...
  function MaknyosHelper(baseURI) {
    ...
    if (
      "function" !== typeof GM_log ||
      (gvar.isFF = navigator.userAgent.indexOf("Firefox") !== -1)
    ) {
  ...
  MaknyosHelper.prototype = {
    ...
    matchAction: function () {
      if (this.domain) this.action.find(this.domain);
      return this;
    },

    invokeAction: function () {
      if (this.action.invoked) {
        if (!this.action.noBaseClean) this.action.baseCleanUp();
        this.action.invoked();
      }
      return this;
    },
  ...
  Actions.prototype = {
    find: function (domain) {
      ...
      for (var key in this.patterns) {
        ...
        isMatch =
          typeof pattern.rule === "string"
            ? pattern.rule == domain
            : pattern.rule.test(domain);
        if (isMatch) {
          this.invoked = pattern.run;
          this.noBaseClean =
            !isUndefined(pattern.noBaseClean) && pattern.noBaseClean;
          return;
        }
      }
    },
    ...
    parse_handle_href: function (x) {
      var cucok, href;
      if ("string" == typeof x) href = x;
      else if ("object" == typeof x) href = x.getAttribute("href");

      if (href && /\/handle\?/.test(href)) {
        href = href.replace("&amp;", "&");
        if ((cucok = /\&?fl=((?:f|ht)tps?[^\&]+)/i.exec(href)))
          href = decodeURIComponent(cucok[1]);
        else this.clog("parsing fail on href, missing param `fl=`");
      }
      return href;
    },
    ...
    trySumbit: function (button, cb_before) {
      ...
      if (button.nodeName != "FORM") tform = this.closest(button, "form");

      if ("function" === typeof cb_before) cb_before(tform);

      if (tform) {
        if ((el = g('[name="referer"]', tform))) el.value = "";

        if (button.nodeName != "FORM" && button.getAttribute("name")) {
          el = document.createElement("input");
          el.setAttribute("type", "hidden");
          el.setAttribute("name", button.getAttribute("name"));
          if (button.value) el.value = button.value;
          else if (button.textContent) el.value = button.textContent;
    ...
    waitforit: function (waitwhat, thenwhat, delay) {
      var ME = this,
        ...
        thenwhatwrap = function (r) {
          ...
          "function" == typeof thenwhat && thenwhat(r);
        };
      ...
      if ("function" == typeof waitwhat) {
        var waitwrap = function () {
          ...
          if ((r_ = waitwhat())) {
            ...
            if (itry < maxtry) stoWait = setTimeout(waitwrap, delay + 1000);
            else {
    ...
    frameload: function (url) {
      ...
      if (g("#" + idfrm)) g("#" + idfrm).removeChild();
      ...
      iframe.setAttribute(
        ...
        "position:absolute; z-index:999999; " +
          (gvar.__DEBUG__
            ? "border:1px solid #000; left:0; top:0; width:100%;"
            : "border:0; height:0; width:0; left:-9999; bottom:9999")
      );
      iframe.setAttribute("src", url);

      body = g("body");
      if (gvar.__DEBUG__) body.insertBefore(iframe, body.firstChild);
      else g("body").appendChild(iframe);

      if (gvar.__DEBUG__) {
        if (g("#" + idfrm)) this.clog("iframe created, src=" + url);
        else this.clog("error while creating iframe");
      }
    },
    // resize capcay
    ...
    scrap_simplecapcay: function (el_code) {
      ...
      if ($trycode.length) {
        ...
        if (codes.length) $code.val(codes.join(""));
      }
    ...
    scrapScriptsByRegex: function (pattern, parent) {
      ...
      for (var i = 0; i < scripts.length; i++) {
        if ((inner = scripts[i].innerHTML)) {
          this.clog(inner);
          if ((cucok = pattern.exec(inner))) break;
        }
      }
      return cucok;
    },
    ...
    killframes: function (par) {
      ...
      for (var i = o.length - 1; i >= 0; i--) o[i].parentNode.removeChild(o[i]);
    ...
    show_alert: function (msg, force) {
      ...
      if ("function" == typeof GM_log) {
        ...
        if (typeof msg == "object") GM_log(msg);
      } else {
  ...
  Actions.prototype.patterns = {
    sendspace: {
      ...
      run: function () {
        ...
        g("#download_button") &&
          SimulateMouse(g("#download_button"), "click", true);
      },
    },
      ...
      run: function () {
        ...
        if ((dcg = g("#docControlGroup"))) {
          ...
          if ("function" === typeof $ && site_key) {
            $(".g-recaptcha", dcg).replaceWith(
              $(
                '<div id="maknyos-recaptcha" data-bijikuda="1" data-sitekey="' +
                  site_key +
                  '"></div>'
              )
            );
          ...
          that.waitforit(
            ...
            function () {
              ...
              nbtn.setAttribute(
                "onclick",
                "location.href=this.href; return !1"
              );
    ...
    uptobox: {
      ...
      run: function () {
        ...
        if (countdown) {
          ...
          for (var i = 0; i < scripts.length; ++i) {
            if (
              (cucok = /\bcountdownNum\s*=\s*(\d+)/.exec(scripts[i].innerHTML))
            ) {
          ...
          if (waitFor) {
            this.waitforit(
              function () {
                ...
                return "undefined" != typeof disabled && disabled
                  ? !1
                  : btnDownload;
              },
              function (el) {
          ...
          if (btnDownload) {
            ...
            if (btnDownload) {
              ...
              if (!btnDownload.getAttribute("disabled")) {
                ...
                waitStr = String(g("#countdown_str").textContent)
                  .replace(/[\s\W]/g, "")
                  .toLowerCase();
                if (
                  (cucok = /(?:[a-zA-Z]+)?(\d+)(?:[a-zA-Z]+)?/.exec(waitStr))
                ) {
                  this.waitforit(
                    function () {
              ...
              if ((link = el.parentNode)) {
                rlink = getParameterByName(
                  "prod" + "uct_d" /*fo*/ + "ownloa" + "d_url",
        ...
        if ((btnDl = g("[name=F1]"))) {
          sTryStop = setInterval(function () {
            ...
            if (iTry > maxTry) {
              ...
              if ("function" == typeof cb_pagestop) cb_pagestop();
            }
          }, 10);
        } else {
        ...
        this.waitforit(
          function () {
            var $pcw = $(".preview-content-wrapper"),
              ...
              $btn1 = xp(
                './/button[contains(@data-type, "download-btn")]',
                $phr.get(0),
                true
              ),
              $btn2 = xp(
      ...
      run: function () {
        var that = this,
          api_url =
            ...
            "//" +
            location.hostname +
            "/public-api-desktop/download-url";

        that.clog("inside yadi, " + that.get_href());
        this.waitforit(
          function () {
            return (el = xp(
              '//button[contains(@class,"button2") and contains(.,"ownloa")]',
              null,
              true
            ));
          },
                ...
                for (var key in json) {
                  ...
                  switch (key) {
                    ...
                    case "resources":
                      ...
                      if (
                        firstKey &&
                        "undefined" != typeof item[firstKey]["hash"]
                      ) {
    ...
    datafilehost: {
      ...
      run: function () {
        ...
        if (
          (btnDownload = xp(
            '//a[contains(@href,"/get.php?") or contains(@class,"ownloa")]',
            null,
            true
          ))
        )
          setTimeout(function () {
            if (
              (href = that.parse_handle_href(btnDownload.getAttribute("href")))
            )
    ...
    userscloud: {
      ...
      run: function () {
        var that = this,
          ...
          tform = null,
          btn_selector =
            '//button[contains(@id, "ownlo") and not(contains(@disabled,"disabled"))]';
    ...
    dailyuploads: {
      ...
      run: function () {
        ...
        if (
          (par = g(".inner")) &&
          xp('//h2[contains(text(),"Link Generated")]', par, true)
        ) {
          ...
          if ($("#chkIsAdd").is(":checked")) $("#chkIsAdd").trigger("click");

          if (recapcay) {
            site_key = recapcay.getAttribute("data-sitekey");
            that.clog("Recapcay found, site_key: " + site_key);

            $(recapcay).replaceWith(
              $(
                '<div id="maknyos-recaptcha" data-sitekey="' +
                  site_key +
                  '"></div>'
              )
            );
            ...
            if (form) that.trySumbit(form);
            else if (btnDl) that.trySumbit(btnDl);
            else that.clog("Missing download button");
          } else {
    ...
    rgho: {
      ...
      run: function () {
        var that = this,
          href = "",
          btn_selector =
            '//a[contains(@href,"/download/") and contains(text(),"ownload")]';

        if ((btnDl = xp(btn_selector, null, true))) {
          href = btnDl.getAttribute("href");

          if (href) that.set_href(href);
          else SimulateMouse(btnDl, "click", true);
        } else {
    ...
    uploadee: {
      ...
      run: function () {
        ...
        if (wrapBox) {
          ...
          if (btnDl) SimulateMouse(btnDl, "click", true);
          else this.clog("uploadee: missing download button, page may changed");
        } else {
    ...
    shst: {
      ...
      run: function () {
        ...
        for (var i = 0; i < scripts.length; ++i) {
          ...
          if (
            null === cbu &&
            (cucok = /callbackUrl\s*:\s*[\'\"]([^\'\"]+)/i.exec(innerScript))
          )
            cbu = cucok[1];

          if (
            null === si &&
            (cucok = /sessionId\s*:\s*[\'\"]([^\'\"]+)/i.exec(innerScript))
          )
            si = cucok[1];

          if (cbu != null && si != null) break;
        }
        ...
        if (cbu && si && "function" == typeof reqwest) {
          ...
          that.clog(
            "Missing callbackUrl | sessionId" +
              ("undefined" == typeof reqwest ? " | reqwest is Undefined" : "")
          );
        }
      },
    },
    ...
    adfly: {
      ...
      run: function () {
        ...
        var continuum = function (ndv) {
          ...
          if (ndv) {
            var poluted = ndv.indexOf("!HiT" + "o" + "mmy"),
              a = "",
              b = "";
            if (poluted >= 0) ndv = ndv.substring(0, poluted);
            ...
            ndv = atob(a + b);
            ndv = ndv.substr(2);
            if (location.hash) ndv += location.hash;
          ...
          if (elck) elck.parentNode.removeChild(elck);
          ...
          that.waitforit(
            ...
            function () {
              ...
              else that.clog("Unable get redirect link");
            },
            345
          );
        };
        ...
        var ping_url =
            location.protocol + "//" + location.hostname + "/callback/",
    ...
    mypcloudcom: {
      ...
      run: function () {
        var that = this,
          btn_selector =
            '//div[contains(@class,"button") and contains(text(),"ownload")]';
        if (xp(btn_selector, g(".button-area"), true)) {
          var scriptHandler = function (_site_key) {
            return (function (win, $) {
              ...
              if (
                "undefined" != typeof publinkData &&
                publinkData.downloadlink
              ) {
          ...
          scriptHandler = scriptHandler.toString();
          scriptHandler = scriptHandler.replace(
            /___func_simulatemouse___/,
            SimulateMouse.toString()
          );
          scriptHandler = scriptHandler.replace(/___func_g___/, g.toString());
          scriptHandler = scriptHandler.replace(
            /___func_frameload___/,
            that.frameload.toString()
          );
    ...
    uploadrocket: {
      ...
      run: function () {
        var that = this,
          ...
          btnDl = null,
          href;
        if (form) btnDl = g("[name=method_isfree]", form);
        ...
        if (form && btnDl) {
          ...
          if (btnDl) {
            ...
            that.clog(
              "uploadrocket: missing download button, page may changed"
            );
          }
        }
      },
    ...
    uplodorg: {
      ...
      run: function () {
        ...
        if (tform || btnDl) {
          ...
          if ((el = g("#chkIsAdd"))) el.checked = false;
      ...
      run: function () {
        ...
        if (recapcay && g("#method_free")) {
          ...
          if (btnDl) {
            ...
            if ((btnCheck = g("#chkIsAdd"))) btnCheck.checked = false;
            ...
            that.clog(
              "Not download page or missing download button [Stage-?], page may changed"
            );
          }
        }
      },
                ...
                callback: function (e) {
                  ...
                  if ($dialog && $dialog.length)
                    setTimeout(function () {
                      ...
                      if (gvar.observer) gvar.observer.disconnect();
                    }, 123);
                },
              };
      ...
      run: function () {
        ...
        if (/drive.google.com/.test(loc)) {
          ...
          var $wrapper = $(".drive-viewer"),
            ...
            countdown = 4,
            $btn_cancel = $(
              '<a href="javascript:;" class="drive-viewer-dark-button goog-inline-block drive-viewer-button drive-viewer-button-clear-border btn-cancelredirect">cancel</a>'
            );
          $btn_cancel.click(function (e) {
            if (gvar.stoRedirectGDrive) clearInterval(gvar.stoRedirectGDrive);
      ...
      run: function () {
        ...
        healLinks = function () {
          ...
          if (!$parent.length || !$parent.html()) {
            if ($parent.length) $parent = $('table[rules="cols"]');
            else $parent = $("table");
          }

          setTimeout(function () {
            $(
              'a[href*="ads.php"], a[href*="book/index"], a[href*="libgen.me"], a[href*="bookzz.org"], a[href*="bookfi.net"]',
              $parent
            ).each(function () {
              var $me = $(this),
                href = $me.attr("href");
              $me.html("" + "<strong>" + $me.text() + "</strong>");
          ...
          case "en.bookfi.net":
            ...
            if (rows && rows.length == 1) {
              if ((btnDl = g(".ddownload", rows[0]))) {
                try {
                  if ((href = btnDl.getAttribute("href"))) that.set_href(href);
                } catch (e) {
                  SimulateMouse(btnDl, "click", true);
                }
              } else that.clog("Missing download button");
              ...
              if (
                (btnDl = xp(
                  '//a[contains(.,"ownloa") and contains(@href,"/dl/")]',
                  null,
                  true
                ))
              ) {
    ...
    filescdn: {
      ...
      run: function () {
        ...
        if ((btnDl = g("#btn_download"))) {
          ...
          (btnDl = xp(
            '//a[(contains(.,"ownloa") and contains(.,"irect")) or contains(.,"eady!")]',
            null,
            true
          ))
        ) {
      ...
      run: function () {
        ...
        if (recapcay) {
          ...
          if ("function" === typeof $ && site_key) {
            ...
            if (g("#maknyos-recaptcha")) that.clog("g-recaptcha tampered");
            else that.clog("tampering g-recaptcha FAILED");
          ...
          return that.waitforit(
            function () {
              ...
              if (!g(sel)) {
                ...
                else sel = '[type="submit"][name="method_free"]';
              }
              that.clog("sel=" + sel);

              if (sel) return g(sel, null, true);
            },
            function (el) {
              var hid = null;
      ...
      run: function () {
        ...
        if (section) {
          ...
          // # stage-2
            ...
            btnDl = xp(
              '//*[contains(@class,"btn") and contains(.,"ownloa")]',
              null,
              true
            );
            if (!btnDl) {
              btnDl = xp(
                './/a[contains(@href,"upera.co") and last()]',
                g(".panel", section),
                true
              );
            }
        ...
        if ((btnDl = g('[type="submit"][name="method_free"]', null, true))) {
          ...
          if (countdown && (countdown = parseInt(countdown.textContent) - 1)) {
            ...
            if ((btnDl = g("#downloadbtn", tform))) {
              ...
              if (recapcay) cb_countdown();
              else that.trySumbit(btnDl);
            }
      ...
      run: function () {
        ...
        if (btnDownload) {
          ...
          btnDownload.innerHTML =
            '<i class="fa fa-google"></i> Login to Download File..';
          try {
      ...
      run: function () {
        ...
        if ((btnDl = g("#downloadbtn"))) {
          ...
          if (g(".directlinkpage") || g(".downloadfile1"))
            that.clog("missing download button");
          else that.clog("Not download page");
        }
      },
    },
        ...
        if ((btnDl = g("#inputDownWait>.slow_button"))) {
          if (!that.isVisible(interval)) {
            ...
            setTimeout(function () {
              ...
              if (vth && that.isVisible(vth)) {
                if ((wrap = g("td>div", vth))) {
                  ...
                  el.style.color = "#d00";
                  el.innerHTML =
                    "Press ENTER to continue<br/><small>You may need to wait 30 seconds before download started</small>";
                  wrap.appendChild(el);
                }
            ...
            if ((waitFor = g("#down_interval_tag"))) {
              ...
              if (/minut/.test(unit)) waitFor = waitFor * 60;
              else if (/hour/.test(unit)) waitFor = waitFor * 60 * 60;
    ...
    yimuhe: {
      ...
      run: function () {
        ...
        if (g(".sharp .w630")) {
          ...
          if ((el = g("#download"))) el.style.backgroundColor = "#f0f0f0";
                ...
                if (el__) {
                  if ("undefined" != typeof $) {
                    $(el__).on("keydown", function (e) {
                      that.clog(
                        "keydown=" + $(this).val() + "; e.keyCode=" + e.keyCode
                      );
                      if (e.keyCode === 13 && btnDl) wrap_waitfor(btnDl);
                    });
                  }
                  setTimeout(function () {
                    el__.focus();
                  ...
                  if ((tform = g("form", g(".yzm")))) tform.submit();
                }
              },
              567
            );
    ...
    jzrputtbut: {
      ...
      run: function () {
        ...
        that.waitforit(
          ...
          function (el) {
            if (el) SimulateMouse(el, "click", true);
          },
          100
        );
      },
          ...
          if (recapcay) {
            ...
            if (site_key) {
              ...
              $(hs)
                ...
                .replaceWith(
                  $(
                    '<div class="alert alert-success alert-waiting"><h3 style="text-align:center;">Wait For it...</h3></div>'
                  )
                );
        ...
        if ((parDT = g(".download_timer"))) {
          ...
          $.post(url, pdata, function (ret) {
            ...
            if (ret && ret.direct_link) {
              ...
              var $el = $(
                "<a " +
                  (ret.hash_data ? 'hash-data="' + ret.hash_data + '"' : "") +
                  ' class="download_buttonX" style="color: #ff0000; border: 5px solid #ff0000;" href="' +
                  ret.direct_link +
                  '">DOWNLOAD</a>'
              );
              ...
              if ($el.length) SimulateMouse($el.get(0), "click", true);
            } else {
          ...
          that.waitforit(
            ...
            function (el) {
              if (!dlGotIt) SimulateMouse(el, "click", true);
            },
            1000
          );
        } else {
    ...
    "4shared": {
      ...
      run: function () {
        var that = this,
          ...
          url = that.get_href();
        if (!(cucok && cucok.length > 1)) return !1;
    ...
    bdnupload: {
      ...
      run: function () {
        ...
        if ((btnDl = g('[type="submit"][name="method_free"]', null, true))) {
          ...
          xp("//" + wrapper + '[contains(text(),"Link Generated")]', pSel, true)
        ) {
          host = host.replace(/^w{3}\./, "");
          btnDl = g('a[href*=".' + host + '"]');

          if (!btnDl) btnDl = g("#direct_link>a");
    ...
    "9xupload": {
      ...
      run: function () {
        ...
        if ((btnDl = g("#downloadbtn"))) {
          ...
          xp('//*[contains(text(),"d Link Generated")]', g("table", par), true)
        ) {
    ...
    indishare: {
      ...
      run: function () {
        ...
        if ((btnDl = g("#btn_download"))) {
          ...
          par &&
          (elxp = xp('//h1[contains(text(),"Link Generated")]', par, true))
        ) {
          if (
            (btnDl = g(
              'a>img[src*="' + location.hostname + '"]',
              elxp.parentNode
            ))
          ) {
            btnDl = btnDl.parentNode;
      ...
      run: function () {
        ...
        if ((btnDl = g(".greenActionButton", wrapper))) {
          ...
          if ((el = g('[name="' + tokenfield + '"]'))) {
            ...
            if ((el = g('[name="FileId"]'))) pdata.fileId = el.value;
      ...
      run: function () {
        ...
        if (btnDl) {
          ...
          if (parent.nodeName == "FORM") {
            ...
            if (
              !/https?\:/.test(btnDl.getAttribute("href")) &&
              btnDl.getAttribute("onClick")
            ) {
              if (
                (cucok = /(https?\:[^\'\"]+)/.exec(
                  btnDl.getAttribute("onClick")
  ...
  function SimulateMouse(elem, event, preventDef, prefilter) {
    ...
    if (href && /^((?:(?:ht|f)tps?\:\/\/){1}\S+)/.test(href)) {
      try {
        if ("function" == typeof prefilter) href = prefilter(href);
      ...
      MNy.action.clog(
        "Element is either not link or invalid format. href=" + href
      );
    }
  ...
  function getParameterByName(name, the_url) {
    ...
    if (isUndefined(the_url)) the_url = location.search;
